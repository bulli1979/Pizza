...
public class OrderStepOverview implements PizzaScene{
	private Pane root;
	private SceneManager sceneManager;
	private Scene scene;
	private HBox navigation;
	private Pane center;
	public OrderStepOverview(){}
	private OrderStepOverview(Builder builder){
	...
	public static class Builder{
		...
		public OrderStepOverview build(){
			return new OrderStepOverview(this);
		}
